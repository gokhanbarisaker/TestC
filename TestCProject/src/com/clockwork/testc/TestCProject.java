...
public class TestCProject extends Activity 
{
    ...
    protected void onStart()
    {
    	...
    	Intent chooseLanguage = new Intent(TestCProject.this, LanguageSelector.class);
    	...
    	switch(requestCode)
    	{
    		case LOCALIZATION_DATA_REQUEST_CODE:
    		{
    			if(resultCode == Activity.RESULT_OK)
    			{
    				...
    				Intent mainMenu = new Intent(TestCProject.this, MainMenu.class);
